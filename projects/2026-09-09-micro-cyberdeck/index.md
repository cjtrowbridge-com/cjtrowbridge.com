...
description: A tiny, portable cyberdeck built for high-power computing on the go.
pubdate: 2026-09-09
lastUpdated: 2026-09-10
---


The micro cyberdeck is a tiny, portable computer designed for computing on
the go.

## Capabilites

This is a full ARM64 computer with similar specs to a Steamdeck. It should technically support most Steam games through Proton, though not all of this is realistically going to work perfectly in the short-term because a lot of it is still being implemented in the drivers and software.
