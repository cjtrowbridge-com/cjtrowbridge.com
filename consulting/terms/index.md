---
layout: simple
title: Consulting Terms and Conditions - CJ Trowbridge
...
These Consulting Terms and Conditions ("Terms") govern paid consultations
booked with CJ Trowbridge ("Consultant," "I," "me," or "my").

By booking, paying for, or participating in a consultation after accepting these
Terms through one of the methods in Section 34, you ("Client" or "you")
acknowledge that you have read, understood, and agreed to these Terms.

**IMPORTANT DISPUTE NOTICE: THESE TERMS CONTAIN A BINDING ARBITRATION
AGREEMENT. EXCEPT FOR CERTAIN CLAIMS DESCRIBED BELOW, YOU AND I AGREE TO
RESOLVE DISPUTES THROUGH BINDING ARBITRATION RATHER THAN A LAWSUIT BEFORE A
JUDGE OR JURY. YOU ARE WAIVING THE RIGHT TO A JURY TRIAL FOR COVERED CLAIMS.**
...
You must be at least 18 years old and have the legal capacity and authority to
enter into these Terms. If you book on behalf of an organization, you represent
...
## 5. Possibility of Errors, Omissions, and Uncertainty
...
## 6. No Licensed Professional Advice
...
## 7. Client Responsibility for Decisions
...
## 10. Recording, Transcription, and AI Meeting Tools
...
Nothing in these Terms obligates me to provide advice, assistance, information,
or services that I reasonably believe would be unlawful, unsafe, unethical, or
outside the agreed scope of the consultation. If I decline or terminate a
consultation for another reason, the refund provision in Section 2 applies.

## 13. Third-Party Services and Technology
...
If a comparable rescheduled appointment is not reasonably available, the Client
may receive a refund for the affected consultation.
...
Nothing in these Terms excludes, waives, or limits liability for fraud, willful
misconduct, willful injury, violation of law, or any other liability that
applicable law does not permit the parties to exclude, waive, or limit.
...
## 17. No Agency, Partnership, Fiduciary, or Employment Relationship
...
## 18. Informal Resolution Required Before Arbitration
...
2. the consultation involved;
3. the factual basis of the dispute;
4. the relief or resolution requested; and
5. any amount of money claimed.
...
## 19. Agreement to Binding Individual Arbitration
...
* a consultation;
* booking or payment for a consultation;
* cancellation or refund disputes;
* statements or representations concerning the consultation;
* these Terms;
* the relationship between Client and Consultant; or
* the interpretation, applicability, breach, enforcement, formation, validity, or termination of these Terms
...
The arbitration will be conducted before one neutral arbitrator selected by the
Consultant. The arbitrator must have no material financial, professional, or
personal relationship with either party and must make all disclosures required
by applicable law. The selection remains subject to applicable disqualification
or recusal standards.

Unless applicable law requires otherwise, the arbitration will take place in
Sacramento County, California. At the arbitrator's discretion, proceedings may
take place remotely by video, telephone, written submissions, or another
reasonably appropriate method.
...
The arbitrator may award any individual remedy or relief that would otherwise
be available to the individual party under applicable law, subject to the valid
limitations contained in these Terms. Nothing in these Terms waives the right
to seek public injunctive relief where that right cannot lawfully be waived. A
claim for such relief may proceed in court to the extent applicable law
requires.
...
## 20. Arbitration Costs

For a consumer arbitration, the Client will pay no more than the fees that
applicable law permits a consumer to pay. I will pay the arbitration and
arbitrator fees that applicable law requires a business to pay.

Any fee waiver, reduction, or other cost protection available under applicable
law remains available to the Client. No Client will be required to pay a fee or
cost that applicable law requires me to pay.
...
## 21. Arbitration of Arbitrability and Delegation
...
## 24. Provisional and Emergency Relief
...
## 25. Arbitration-Specific Severability
...
## 26. Survival of Arbitration Agreement
...
## 28. Court Venue for Non-Arbitrable Matters

For any dispute that is not subject to arbitration and is not properly brought
in small-claims court, the parties consent to the exclusive jurisdiction and
venue of the state and federal courts located in or serving Sacramento County,
California, except where applicable law gives a party a non-waivable right to
proceed elsewhere.

## 29. General Severability
...
I will retain a reproducible copy of that version together with the date and
record of the Client's acceptance.
...
1. by selecting the required acceptance checkbox while booking through a
   scheduling provider;
2. by sending an email from the address used for the consultation that clearly
   states your acceptance of these Terms before the consultation is confirmed;
   or
3. by electronically signing these Terms through a third-party electronic
   signature service.

The version presented at the time of acceptance governs the consultation. I
will retain a record of the method, date, and version accepted.

By accepting these Terms through any of these methods, you acknowledge that:

* you were provided an opportunity to review these Terms before purchasing the consultation;
* you understand that these Terms contain limitations of liability and a binding arbitration agreement;
* you understand that arbitration generally replaces the right to proceed before a judge or jury;
* you agree to be bound electronically by these Terms.

## 35. Contact and Legal Notices

Questions concerning a booking and formal notices concerning a dispute or
arbitration must be sent by email to:

CJ Trowbridge
cj@cjtrowbridge.com

A notice is considered received when delivered to that email address, subject
to any different notice requirement imposed by applicable law.


These terms apply to appointments and services booked through the
[consulting page](/consulting/) or by reaching out directly.

<a class="btn btn-calendly" href="/consulting/">
  <i class="fa-solid fa-arrow-left"></i> Back to Consulting
</a>
